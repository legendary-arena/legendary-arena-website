...
| WP-046 | Lighthouse-on-CI performance gate — make the ≥90 P/A/BP/SEO invariant an automated PR merge gate (median-of-N Lighthouse over a page matrix), so a future WP that reintroduces a render-blocker/heavy asset fails CI instead of shipping. Closes the "silent regression" gap WP-043 exposed and WP-044/WP-011 named as the top follow-on | 📝 Drafted — ready to build | ~half-day | [WP-046](work-packets/WP-046-lighthouse-ci-gate.md) |
...
| WP-046 | WP | Lighthouse-on-CI performance gate | 📝 Drafted | P2 | ~half-day | — | WP-044 (baseline to protect) |
