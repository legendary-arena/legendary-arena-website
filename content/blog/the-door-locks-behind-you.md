...
date: 2026-09-24
description: "A Mastermind rarely wins by hitting hardest. It wins by scheme. Five questions expose a scheme's shape, at the table and beyond, without naming a villain."
draft: false
...
Every game of Legendary puts one Mastermind at the top of the board, and new
players nearly always misread it the same way. They see the Attack number and
think the danger is the hit.

It isn't. A Mastermind that only hits hard is a stat block, and a good table
learns to burst it down. The Mastermind that actually beats you does it by
**scheme**. It floods the street so you stop looking at the throne. It offers a
small, reasonable bargain that turns out to be the rope. It changes the rules
halfway through, so the plan you drafted no longer works against the boss you
face. By the time you notice the Scheme was the real clock, the clock has run
out.

That is why the game puts a Scheme next to every Mastermind. Evil is not only
strength. It is arrangement: who sees what, who is believed, and what it costs
to walk away.

Outside the game, the arrangements are harder to see, because nobody lays the
...
Almost nobody experiences himself as the villain. The men who built the worst
regimes of the last century believed they were saving a civilisation or ending
exploitation. Motive is invisible. It is also the easiest thing in the world to
...
need to punish anyone at step four.

## Two locks

Every scheme needs a door that is hard to walk back through, and there are two
kinds.

The **hard lock** is the physical door: the wall, the camp, the bullet. It is
brutal and it is honest about itself.

The **soft lock** is the social door. You are free to walk out, but you walk out
unemployable, labelled, or ruined. A regime that trusts its soft lock does not
need the hard one. If leaving costs your livelihood and your name, almost nobody
tests the wall. It is cheaper, and from the outside it looks like freedom.

## How the lock holds

A few mechanisms keep showing up once you start looking.
...
Robespierre to Napoleon, Tsar to Lenin to Stalin, Batista to Castro, the Shah to
Khomeini. The Mastermind slot is fixed. Only the name on the card changes.
...
was false. The associate head coach, Melissa Batie-Smoose, filed a Title IX
complaint in late October 2024 and was pulled from the team four days later,
just before a match, with only the word that she was "not with the team at this
...
The five questions will not name a person. That is deliberate.

The moment a tool promises to identify the Mastermind, it becomes a way to
confirm whatever suspicion someone already had. The lens gives you something more
useful: a verdict on the *structure*. It tells you who is shielded from scrutiny,
what dissent costs, and why nobody is testing the door. It is a filter, not an
accusation. It strips the noise down to a few facts you can actually check, so you
can decide whether to join something, stay in it, or believe what it tells you.

And it has to apply both ways. Ask the five questions of every arrangement,
including the ones you like, or you haven't used the lens. You've only aimed it.

## The one who broke both locks

There is one story where both locks meet their answer.

Jesus named the soft lock out loud instead of hiding it: "They shall put you out
of the synagogues" (John 16:2). Following Him would cost the disciples their
standing, and He told them so, then asked them to come anyway. The hard lock He
broke from the inside. The tomb is the one wall in history that did not hold.

He does not only get you out, either. "Ye have received the Spirit of adoption,
whereby we cry, Abba, Father" (Romans 8:15). The exit leads to a family.

## Leaving the circle

One last picture. Boys stand in a ring. One punches the boy beside him and says
*pass it on*. Everyone in the circle is both hit and hitter, which is why
counting the blows you took can never get you out. If you only track what was
done to you, you never notice you are still swinging.

The way out is the apology, not the pardon. Waiting to be released keeps you
standing in the ring, because your release depends on the man behind you. Taking
responsibility is the one move nobody has to allow. Then you step out of the
circle, and you don't pick it back up.

Forgive personally. Remember institutionally. Release without responsibility is
drift. Responsibility without release is bitterness with a work ethic.

At the table, the heroes beat the Mastermind by seeing the Scheme for what it is
and refusing the two boxes it offers. The same lens works when you close the
box. Ask the five questions, check the door, and play the hand you actually hold.
